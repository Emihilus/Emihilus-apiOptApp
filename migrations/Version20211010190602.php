 ...
 */
final class Version20211010190602 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE saved_imgwmeasurement (id INT AUTO_INCREMENT NOT NULL, station_id INT NOT NULL, station VARCHAR(30) NOT NULL, date VARCHAR(30) NOT NULL, temp VARCHAR(16) NOT NULL, wind_dir INT NOT NULL, wind_speed INT NOT NULL, relative_humidity VARCHAR(25) NOT NULL, drop_sum VARCHAR(25) NOT NULL, pressure VARCHAR(20) NOT NULL, requested_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE saved_language_recognition_detection (id INT AUTO_INCREMENT NOT NULL, saved_language_recognition_request_id INT NOT NULL, recognized_lang VARCHAR(3) NOT NULL, is_reliable TINYINT(1) NOT NULL, confidence_score VARCHAR(20) NOT NULL, INDEX IDX_4B3403B18C5E5DC8 (saved_language_recognition_request_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE saved_language_recognition_request (id INT AUTO_INCREMENT NOT NULL, source_text LONGTEXT NOT NULL, requested_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
