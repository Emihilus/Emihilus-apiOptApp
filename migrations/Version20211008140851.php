 ...
 */
final class Version20211008140851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE saved_imgwmeasurement (id INT AUTO_INCREMENT NOT NULL, station_id INT NOT NULL, station VARCHAR(255) NOT NULL, date VARCHAR(255) NOT NULL, temp VARCHAR(255) NOT NULL, wind_dir INT NOT NULL, wind_speed INT NOT NULL, relative_humidity VARCHAR(255) NOT NULL, drop_sum INT NOT NULL, pressure VARCHAR(255) NOT NULL, requested_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
